# Contributing to slack-invite-webtask

First and foremost, thank you! We appreciate that you want to contribute to slack-invite-webtask, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for slack-invite-webtask**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for slack-invite-webtask:

- star the [project](https://github.com/doowb/slack-invite-webtask)
- tweet your support for slack-invite-webtask
...
- **version**: please note the version of slack-invite-webtask are you using
...
[so]: http://stackoverflow.com/questions/tagged/slack-invite-webtask
